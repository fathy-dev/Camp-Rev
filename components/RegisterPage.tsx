            ...
            <div className="w-full max-w-md bg-white relative z-10 animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5 group">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-4 text-slate-900 font-bold placeholder-slate-300 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all pr-12"
                                    placeholder="••••••••"
                                    disabled={isLoading || isGoogleLoading}
                                />
                                <button
                    ...
                    <button
                        ...
                        disabled={isLoading || isGoogleLoading}
                        className="mt-4 w-full py-4 bg-white border border-slate-100 text-slate-700 font-bold rounded-2xl hover:bg-slate-50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                        {isGoogleLoading ? (
